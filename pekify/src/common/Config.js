...
export default {
  ...
  appFacebookId: "xxxxxxxxxxx",
  CustomPages: { contact_id: 10941 },
  WebPages: { marketing: "http://pekify.com" },

  intro: [
    {
      key: "page1",
      title: "Welcome to Pekify",
      text: "Get order from your favorite store delivered to your doorstep",
      icon: "ios-basket",
  ...
  ProfileSettings: [
    ...
    },
    {
      ...
      routeName: "CustomPage",
      params: {
        url: "https://pekify.com/term-of-service"
      }
    },
    {
      label: "About",
