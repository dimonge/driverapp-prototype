...
const AppNavigator = createBottomTabNavigator(
  {
    ...
    Search: {
      ...
      navigationOptions: {
        tabBarIcon: ({ tintColor }) => (
          <TabBarIcon title="Search" css={{ width: 18, height: 18 }} icon={Images.IconSearch} tintColor={tintColor} />
        )
      }
    },
    ...
    ...(Config.Affiliate.enable
      ...
      : {
          MyOrders: {
            ...
            navigationOptions: {
              tabBarIcon: ({ tintColor }) => (
                <TabBarIcon orderIcon css={{ width: 18, height: 18 }} icon={Images.IconOrder} tintColor={tintColor} />
              )
            }
          }
        }),
 ...
 */
NewsStack.router.getStateForAction = navigateOnce(NewsStack.router.getStateForAction);
CategoryStack.router.getStateForAction = navigateOnce(CategoryStack.router.getStateForAction);
CategoryDetailStack.router.getStateForAction = navigateOnce(CategoryDetailStack.router.getStateForAction);
WishListStack.router.getStateForAction = navigateOnce(WishListStack.router.getStateForAction);
...
CartScreenStack.router.getStateForAction = navigateOnce(CartScreenStack.router.getStateForAction);
