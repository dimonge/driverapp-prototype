...
import { Menu, NavBarLogo, HeaderHomeRight, Logo } from "./IconNav";

@withTheme
export default class HomeScreen extends PureComponent {
  static navigationOptions = ({ navigation }) => {
    const headerStyle = navigation.getParam("headerStyle", Styles.Common.toolbar());
    const dark = navigation.getParam("dark", false);

    return {
      headerTitle: Logo(), //NavBarLogo({ navigation }),
